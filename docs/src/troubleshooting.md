...
[discuss with us](https://github.com/MineralsCloud/LinearElasticityBase.jl/discussions).

If you have additional tips, please either
[report an issue](https://github.com/MineralsCloud/LinearElasticityBase.jl/issues/new) or
[submit a PR](https://github.com/MineralsCloud/LinearElasticityBase.jl/compare) with suggestions.
